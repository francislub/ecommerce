          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" style="background:#ffceff !important;">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Collins</span>-Fashion</h1>
                  <h2>Collins Fashion E-Commerce</h2>
                  <p>Let us enjoy digital shopping. Collins Fashion we makes commodities nearer to our customer all over the country. Let enjoy the new world of no delays together. </p>
