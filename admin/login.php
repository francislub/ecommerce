...
<body>
	<div class="limiter" >
		<div class="container-login10" style="background-image: url('images/1.webp');">

			<div class="wrap-login100">
				<form method="post" action=""  class="login100-form validate-form" >
				<div class="login100-form-avatar">
						<img src="images/log.jpg" alt="AVATAR">
					</div>
                    ...
                    <div>
					<li class="active"><a class="btn btn-default check_out" href="../index.php">User Login</a>
                    </li>
					</div>
				</form>
			</div>
