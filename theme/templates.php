...
<head>
    ...
    <title>Home | Collins Fashion</title>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" >
                <li><a href="#"><i class="fa fa-phone"></i> +256778544331</a></li>
                <li><a href="#"><i class="fa fa-phone"></i> +256743774266</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> collinsfashion@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="col-md-4 clearfix">
            <div class="logo pull-left">
                <a href="<?php echo web_root?>">
                    <img src="images/home/log.jpg" alt="" width="100" height="50" />
                </a>
            </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2>Collins Fashion</h2>
                  <p>Let us enjoy digital shopping. Collins Fashion we makes commodities nearer to our customer all over the country. </p>
              </div>
          </div>
          <div class="col-sm-7">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>We deliver commodities all over the world </p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-right">Designed by <span><a target="_blank" href="">Collin's Programmers</a></span></p>
        </div>
      </div>
    </div>
